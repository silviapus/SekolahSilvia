                          ...
                          if(isset($_POST['submit'])){
                            ...
                            if($_FILES['foto_baru']['name'] !=''){
                                ...
                                if(!in_array($formatfile, $allowedtype)){
                                    ...
                                    echo '<div class="alert alert-error">Format file foto kepala sekolah tidak di izinkan.</div>';

                                    return false;

                                }elseif($filesize > 1000000){
                                    echo '<div class="alert alert-error">Ukuran file foto kepala sekolah tidak boleh dari 1 MB.</div>';
