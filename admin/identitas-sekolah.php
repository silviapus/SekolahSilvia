            ...
            <div class="container">
                ...
                <div class="box">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="gmaps" class="input-control" placeholder="Goggle Maps"><?= $d->google_maps ?></textarea>
                    </div>
                          ...
                          if(isset($_POST['submit'])){
                            ...
                            if($_FILES['logo_baru']['name'] !=''){
                                ...
                                if (!in_array($formatfile_logo, $allowedtype_logo)){
                                    ...
                                    echo '<div class="alert alert-error">Ukuran file logo sekolah tidak boleh dari 1 MB.</div>';
                            ...
                            if($_FILES['favicon_baru']['name'] !=''){
                                ...
                                if (!in_array($formatfile_favicon, $allowedtype_favicon)){
                                    ...
                                    echo '<div class="alert alert-error">Ukuran file favicon sekolah tidak boleh dari 1 MB.</div>';
